...
# Finding the counts
counts <- xml2::xml_find_first(website, "/html/body/div[2]/div/div[3]/main/div[3]/div[3]/div[1]/div[2]/div[5]/table")
...
publications <- GET(
  ...
  query = list(db="pubmed", rettype="abstract", retmax=300, id=I(paste(ids, collapse = ","))
    )
)
...
There are 61 papers without abstract.
...
There are no paper with no title.
